...
Please note that Custom Post Type UI alone will not display post types or taxonomies data in customized places within your site; it simply registers them for you to use. Check out [https://pluginize.com/product/custom-post-type-ui-extended/?utm_source=cptui-desription&utm_medium=text&utm_campaign=wporg](Custom Post Type UI Extended) for an easy way to display post type content from any registered types on your site, including those created with Custom Post Type UI and more.
