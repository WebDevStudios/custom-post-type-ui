 ...
 *
 * Mostly used for auto-population purposes.
 *
 * @since 1.7.0
 *
 * @param string $content_type Whether to return just post type labels, just taxonomy labels, or both if empty.
 *
 * @return array
 */
function cptui_get_all_labels() {

	return [
		'post_types' => [
			'menu_name'                => esc_html__( 'Menu Name', 'custom-post-type-ui' ),
			...
			'not_found'                => esc_html__( 'Not Found', 'custom-post-type-ui' ),
			'not_found_in_trash'       => esc_html__( 'Not Found in Trash', 'custom-post-type-ui' ),
			'parent'                   => esc_html__( 'Parent', 'custom-post-type-ui' ),
			...
			'use_featured_image'       => esc_html__( 'Use Featured Image', 'custom-post-type-ui' ),
			'archives'                 => esc_html__( 'Archives', 'custom-post-type-ui' ),
			'insert_into_item'         => esc_html__( 'Insert into %s', 'custom-post-type-ui' ),
			'uploaded_to_this_item'    => esc_html__( 'Uploaded to this %s', 'custom-post-type-ui' ),
			'filter_items_list'        => esc_html__( 'Filter %s List', 'custom-post-type-ui' ),
			'items_list_navigation'    => esc_html__( '%s List Navigation', 'custom-post-type-ui' ),
			'items_list'               => esc_html__( '%s List', 'custom-post-type-ui' ),
			'attributes'               => esc_html__( 'Attributes', 'custom-post-type-ui' ),
			'name_admin_bar'           => esc_html__( '"New" menu in admin bar', 'custom-post-type-ui' ),
			'item_published'           => esc_html__( '%s Published', 'custom-post-type-ui' ),
			'item_published_privately' => esc_html__( '%s Published Privately', 'custom-post-type-ui' ),
			'item_reverted_to_draft'   => esc_html__( '%s Reverted To Draft', 'custom-post-type-ui' ),
			'item_scheduled'           => esc_html__( '%s Scheduled', 'custom-post-type-ui' ),
			'item_updated'             => esc_html__( '%s Updated', 'custom-post-type-ui' ),
		],
		'taxonomies' => [
			'menu_name'                  => esc_html__( 'Menu Name', 'custom-post-type-ui' ),
			'all_items'                  => esc_html__( 'All %s', 'custom-post-type-ui' ),
			'edit_item'                  => esc_html__( 'Edit %s', 'custom-post-type-ui' ),
			'view_item'                  => esc_html__( 'View %s', 'custom-post-type-ui' ),
			'update_item'                => esc_html__( 'Update %s Name', 'custom-post-type-ui' ),
			'add_new_item'               => esc_html__( 'Add New %s', 'custom-post-type-ui' ),
			'new_item_name'              => esc_html__( 'New %s Name', 'custom-post-type-ui' ),
			'parent_item'                => esc_html__( 'Parent %s', 'custom-post-type-ui' ),
			'parent_item_colon'          => esc_html__( 'Parent %s Colon', 'custom-post-type-ui' ),
			'search_items'               => esc_html__( 'Search %s', 'custom-post-type-ui' ),
			...
			'choose_from_most_used'      => esc_html__( 'Choose From Most Used', 'custom-post-type-ui' ),
			'not_found'                  => esc_html__( 'Not found', 'custom-post-type-ui' ),
			'no_terms'                   => esc_html__( 'No terms', 'custom-post-type-ui' ),
			'items_list_navigation'      => esc_html__( '%s List Navigation', 'custom-post-type-ui' ),
			'items_list'                 => esc_html__( '%s List', 'custom-post-type-ui' ),
		],
	];
