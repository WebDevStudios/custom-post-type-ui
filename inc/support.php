			...
			<tr>
				<td class="outter">
					...
					<ol id="questions_general">
						<li>
							<span class="question" aria-controls="q1" aria-expanded="false"><?php _e( 'I have post types with spaces in their slug and can not successfully delete them. How can I fix that?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q2" aria-expanded="false"><?php _e( 'I changed my custom post type name and now I can not get to my posts. How do I get them back?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q3" aria-expanded="false"><?php _e( 'I changed my custom post type or taxonomy slug and now I have duplicates shown. How do I remove the duplicate?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q4" aria-expanded="false"><?php _e( 'I have added post thumbnail and/or post format support to my post type, but those do not appear when adding a post type post.', 'custom-post-type-ui' ); ?></span>
							<div class="answer" id="q4"><?php _e( 'Make sure your theme has post "post-thumbnails" theme support enabled.', 'custom-post-type-ui' ); ?> <a href="http://codex.wordpress.org/Function_Reference/add_theme_support" target="_blank">http://codex.wordpress.org/Function_Reference/add_theme_support</a></div>
						</li>
						<li>
							<span class="question" aria-controls="q5" aria-expanded="false"><?php _e( 'Do you have any recommendations for an alternative to Visual Composer?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q6" aria-expanded="false"><?php _e( 'Is there any way to get CPTUI-registered post types working with Visual Composer Media Grid?', 'custom-post-type-ui' ); ?></span>
				...
				<td class="outter">
					...
					<ol id="questions_front">
						<li>
							<span class="question" aria-controls="q7" aria-expanded="false"><?php _e( 'What template files should I edit to alter my post type display?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q8" aria-expanded="false"><?php _e( 'How do I display my custom post type on my site?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q9" aria-expanded="false"><?php _e( 'I have added categories and tags to my custom post type, but they do not appear in the archives.', 'custom-post-type-ui' ); ?></span>
			...
			<tr>
				<td class="outter">
					...
					<ol id="questions_advanced">
						<li>
							<span class="question" aria-controls="q10" aria-expanded="false"><?php _e( 'How do I add custom metaboxes to my post type?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q11" aria-expanded="false"><?php _e( 'How do I add a newly registered taxonomy to a post type that already exists?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q12" aria-expanded="false"><?php _e( 'Post relationships?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q13" aria-expanded="false"><?php _e( 'Is there any function reference list?', 'custom-post-type-ui' ); ?></span>
						...
						<li>
							<span class="question" aria-controls="q14" aria-expanded="false"><?php _e( 'How do I filter the "enter title here" text in the post editor screen?', 'custom-post-type-ui' ); ?></span>
